...
__all__ = ('DFL', 'HGBlock', 'HGStem', 'SPP', 'SPPF', 'C1', 'C2', 'C3', 'C2f', 'C3x', 'C3TR', 'C3Ghost',
           'GhostBottleneck', 'Bottleneck', 'BottleneckCSP', 'Proto', 'RepC3', 'PmbConv', 'C2f_Pmb')
...
class PmbConv(nn.Module):
    def __init__(self, channel=256, kernels=[1, 3, 5, 7]):
        ...
        assert min_ch >= 1, f'channel must Greater than {16 * self.groups}, but {channel}'
...
class Bottleneck_Pmb(Bottleneck):
    def __init__(self, c1, c2, shortcut=True, g=1, k=(3, 3), e=0.5):
...
class C2f_Pmb(C2f):
    def __init__(self, c1, c2, n=1, shortcut=False, g=1, e=0.5):
        super().__init__(c1, c2, n, shortcut, g, e)
        self.m = nn.ModuleList(Bottleneck_Pmb(self.c, self.c, shortcut, g, k=(3, 3), e=1.0) for _ in range(n))
